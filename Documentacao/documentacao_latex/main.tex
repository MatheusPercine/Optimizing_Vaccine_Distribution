...
% Ajusta o espaçamento entre capítulos no sumário
\setlength{\cftbeforechapterskip}{1.5em plus 0.5em minus 0.5em}

% Caso queira ajustar também o espaçamento entre seções (opcional)
...
\begin{figure}[b]
\centering
\includegraphics[width=14.217cm,height=9.929cm]{ModeloMonografiaDCCUFRJ-img003.png}
\end{figure}
...
% \textrm{\centering\textcolor{red}{Nota: Não entrar com o título do trabalho na ficha catalográfica em caixa alta.}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
