...
A Programação Linear (PL) é um modelo da teoria de otimização utilizado para representar problemas em que se deseja minimizar ou maximizar uma função objetivo linear sujeita a um conjunto de restrições também lineares.
...
\begin{figure}[ht]
    ...
    \includegraphics[width=10.0cm,height=4.0cm]{figuras/metodo_varredura.png} 
