...
Logo, este trabalho objetivou minimizar o tempo de distribuição de vacinas e mitigar o desperdício das mesmas por meio da modelagem de um Problema de Programação Linear Inteira (PPLI) de forma a satisfazer a demanda de vacinas o máximo possível. Com esse modelo, entidades executivas, como o Ministério da Saúde e Prefeituras, poderiam mitigar os efeitos devastadores de uma pandemia, incluindo mortes, sobrecarga de infraestrutura hospitar e desperdício de vacinas.
