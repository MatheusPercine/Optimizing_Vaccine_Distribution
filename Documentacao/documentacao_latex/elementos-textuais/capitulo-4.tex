...
Como as variáveis $x_{ijv}$ e $z_{jpv}$ representam a quantidade transportada, seus valores devem ser números inteiros e não-negativos, pois não faria sentido transportar meia dose de vacina, por exemplo. Desta forma, se trata de um \textbf{Problema de Programação Linear Inteira}.
