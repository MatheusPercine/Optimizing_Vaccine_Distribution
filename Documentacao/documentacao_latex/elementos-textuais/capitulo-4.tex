...
Como a variável $x_{ijv}$ representa a quantidade transportada, seus valor deve ser um número inteiro e não-negativo. Dessa forma, temos a \textbf{restrição de integralidade e não-negatividade} para a etapa intermunicipal:
