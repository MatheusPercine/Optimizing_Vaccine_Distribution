...
No processo de distribuição de vacinas, o primeiro passo é a distribuição de vacinas pelo Ministério da Saúde a partir do Centro Nacional de Distribuição de Insumos (CENADI), que é localizado em  São Paulo/SP. Nesse centro são coletados amostras de todos os lotes de vacina, que são enviados para Instituto Nacional de Controle de Qualidade em Saúde (INCQS), para que seja 
